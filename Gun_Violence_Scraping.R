...
df2016 <- data.frame(
  ...
  incident_date = df2016[seq(from = 1, to = length(df2016), by = 8)],
  state = df2016[seq(from = 2, to = length(df2016), by = 8)],
  city_county = df2016[seq(from = 3, to = length(df2016), by = 8)],
  address = df2016[seq(from = 4, to = length(df2016), by = 8)],
  no.killed = df2016[seq(from = 5, to = length(df2016), by = 8)],
  no.injured = df2016[seq(from = 6, to = length(df2016), by = 8)]
)
...
df2017 <- data.frame(
  ...
  incident_date = df2017[seq(from = 1, to = length(df2017), by = 8)],
  state = df2017[seq(from = 2, to = length(df2017), by = 8)],
  city_county = df2017[seq(from = 3, to = length(df2017), by = 8)],
  address = df2017[seq(from = 4, to = length(df2017), by = 8)],
  no.killed = df2017[seq(from = 5, to = length(df2017), by = 8)],
  no.injured = df2017[seq(from = 6, to = length(df2017), by = 8)]
)
...
df2018 <- data.frame(
  ...
  incident_date = df2018[seq(from = 1, to = length(df2018), by = 8)],
  state = df2018[seq(from = 2, to = length(df2018), by = 8)],
  city_county = df2018[seq(from = 3, to = length(df2018), by = 8)],
  address = df2018[seq(from = 4, to = length(df2018), by = 8)],
  no.killed = df2018[seq(from = 5, to = length(df2018), by = 8)],
  no.injured = df2018[seq(from = 6, to = length(df2018), by = 8)]
)
...
df2019 <- data.frame(
  ...
  incident_date = df2019[seq(from = 1, to = length(df2019), by = 8)],
  state = df2019[seq(from = 2, to = length(df2019), by = 8)],
  city_county = df2019[seq(from = 3, to = length(df2019), by = 8)],
  address = df2019[seq(from = 4, to = length(df2019), by = 8)],
  no.killed = df2019[seq(from = 5, to = length(df2019), by = 8)],
  no.injured = df2019[seq(from = 6, to = length(df2019), by = 8)]
)
...
df2020 <- data.frame(
  ...
  incident_date = df2020[seq(from = 1, to = length(df2020), by = 8)],
  state = df2020[seq(from = 2, to = length(df2020), by = 8)],
  city_county = df2020[seq(from = 3, to = length(df2020), by = 8)],
  address = df2020[seq(from = 4, to = length(df2020), by = 8)],
  no.killed = df2020[seq(from = 5, to = length(df2020), by = 8)],
  no.injured = df2020[seq(from = 6, to = length(df2020), by = 8)]
) %>% 
  distinct()
